...
BLOG_TITLE = "Active Sensing Collectives"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://activesensingcollectives.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://activesensingcollectives.com/"
BLOG_EMAIL = "thejasvi.beleyur@uni-konstanz.de"
BLOG_DESCRIPTION = "Lab website"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}, website design based on the material-theme'
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.codehilite', 'markdown.extensions.extra', 'fenced_code', 'codehilite', 'extra']
